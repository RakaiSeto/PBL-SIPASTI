  ...
  <nav id="navbar" class="bg-[var(--light-blue)] sticky top-0 z-50 transition-all duration-300">
    <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
      ...
      <div class="flex items-center gap-3 flex-shrink-0" data-aos="fade-right">
        <img src="assets/image/LOGO.svg" alt="Logo SIPASTI" class="w-10 h-10 transform hover:scale-110 transition-transform">
        <h1 class="text-2xl font-bold text-[var(--primary)]">SIPASTI</h1>
      </div>
      <!-- TENGAH: Menu navigasi desktop -->
      <div class="hidden md:flex desktop-menu space-x-8 text-base font-medium justify-center flex-1" data-aos="fade-down">
  ...
  <section id="beranda" class="bg-gradient-to-r from-[var(--light-blue)] to-blue-100 py-16 md:py-20">
    <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
      ...
      <div class="md:w-1/2" data-aos="fade-right" data-aos-delay="200">
        ...
        <button class="bg-[var(--primary)] text-white px-6 py-3 rounded-lg font-medium hover:bg-[var(--primary-hover)] btn">
          Laporkan Kerusakan
        </button>
      </div>
      <!-- Gambar -->
    ...
    <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row gap-12">
      ...
      <div class="md:w-1/2" data-aos="fade-up" data-aos-delay="200">
        ...
        <p class="text-base text-gray-600 mb-8">
          ...
          SIPASTI adalah platform inovatif untuk melaporkan kerusakan di kampus, diciptakan oleh tim Polinema untuk menciptakan lingkungan belajar yang lebih nyaman dan efisien.
        </p>
        <button class="bg-[var(--primary)] text-white px-6 py-3 rounded-lg font-medium hover:bg-[var(--primary-hover)] btn">
    ...
    <div class="grid md:grid-cols-2 gap-10 items-center">
      ...
      <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <!-- Step 2 -->
          <div class="bg-white p-5 rounded-xl shadow-md border-t-4 border-[var(--primary)]" data-aos="zoom-in" data-aos-delay="100">
            <div class="flex items-center mb-2">
          ...
          <!-- Step 3 -->
          <div class="bg-white p-5 rounded-xl shadow-md border-t-4 border-[var(--primary)]" data-aos="zoom-in" data-aos-delay="200">
            <div class="flex items-center mb-2">
          ...
          <!-- Step 4 -->
          <div class="bg-white p-5 rounded-xl shadow-md border-t-4 border-[var(--primary)]" data-aos="zoom-in" data-aos-delay="300">
            <div class="flex items-center mb-2">
      ...
      <div data-aos="fade-left">
        <img src="{{ asset('assets/image/3.jpg') }}" alt="Ilustrasi Cara Kerja SIPASTI" class="w-full rounded-xl shadow-lg" />
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg card" data-aos="fade-up">
          <div class="flex items-center mb-4">
            <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Testimoni Mahasiswa" class="w-16 h-16 rounded-full object-cover mr-4">
            <div>
              <h4 class="font-semibold text-gray-800 text-base">Rina</h4>
              <p class="text-sm text-gray-500">Mahasiswa TI</p>
            </div>
          </div>
          <p class="text-gray-700 text-sm italic">"Lapor fasilitas rusak jadi super cepat! Gak perlu datang ke TU, cukup isi form dan langsung ditindak!"</p>
        </div>
        <!-- Testimoni 2 -->
        <div class="bg-white p-6 rounded-xl shadow-lg card" data-aos="fade-up" data-aos-delay="100">
          <div class="flex items-center mb-4">
            <img src="https://randomuser.me/api/portraits/men/45.jpg" alt="Testimoni Dosen" class="w-16 h-16 rounded-full object-cover mr-4">
            <div>
              <h4 class="font-semibold text-gray-800 text-base">Pak Andi</h4>
              <p class="text-sm text-gray-500">Dosen JTI</p>
            </div>
          </div>
          <p class="text-gray-700 text-sm italic">"Sebagai dosen, saya bisa langsung pantau laporan di kelas. Transparan dan respons cepat."</p>
        </div>
        <!-- Testimoni 3 -->
        <div class="bg-white p-6 rounded-xl shadow-lg card" data-aos="fade-up" data-aos-delay="200">
          <div class="flex items-center mb-4">
            <img src="https://randomuser.me/api/portraits/women/4.jpg" alt="Testimoni Tendik" class="w-16 h-16 rounded-full object-cover mr-4">
            <div>
              <h4 class="font-semibold text-gray-800 text-base">Bu Sari</h4>
              <p class="text-sm text-gray-500">Staf Sarpras</p>
            </div>
          </div>
          <p class="text-gray-700 text-sm italic">"Dengan SIPASTI, laporan masuk langsung ke sistem kami. Memudahkan tim maintenance mengatur prioritas kerja."</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="kontak" class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row gap-12">
      ...
      <div class="md:w-1/2" data-aos="fade-right">
        ...
        <div class="space-y-2">
          <input type="text" placeholder="Nama" class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--primary)] transition-shadow">
          <input type="email" placeholder="Email" class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--primary)] transition-shadow">
          <textarea placeholder="Pesan" class="w-full p-2 border rounded-lg h-28 focus:outline-none focus:ring-2 focus:ring-[var(--primary)] transition-shadow"></textarea>
          <button class="bg-[var(--primary)] text-white px-6 py-2 rounded-lg font-medium hover:bg-[var(--primary-hover)] btn">Kirim</button>
        </div>
      </div>
  ...
  <footer class="bg-[var(--primary)] text-white py-12">
    <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="flex">
          <input type="email" placeholder="Email" class="p-3 rounded-l-lg text-sm w-full text-gray-800 focus:outline-none">
