...
<body class="bg-white text-gray-900">
  ...
  <nav class="bg-blue-50 sticky top-0 z-50">
    <div class="max-w-screen-xl mx-auto px-4 py-4 flex justify-between items-center">
      ...
      <div class="hidden md:flex space-x-6 text-base">
        <a href="#beranda" class="text-gray-600 hover:text-[var(--primary)]">Beranda</a>
        <a href="#layanan" class="text-gray-600 hover:text-[var(--primary)]">Layanan</a>
        <a href="#tentang" class="text-gray-600 hover:text-[var(--primary)]">Tentang</a>
        <a href="#kontak" class="text-gray-600 hover:text-[var(--primary)]">Kontak</a>
      </div>
      <div class="space-x-4">
  ...
  {{-- <section class="py-16 flex items-center bg-blue-50"> --}}
    <section class="h-[700px] py-16 flex items-center bg-blue-50" id="beranda">

      <div class="max-w-screen-xl mx-auto px-4 flex flex-col md:flex-row items-center gap-16">
        <!-- Kolom kiri -->
        <div class="md:w-5/12 mb-8 md:mb-0">
          <h1 class="text-4xl md:text-5xl font-bold mb-4 leading-relaxed">Sistem Pelaporan Sarana dan Prasarana
            Perbaikan<br />JTI - Polinema</h1>
          <p class="text-gray-600 mb-6 text-justify text-sm md:text-lg">
            Laporkan kerusakan fasilitas kampus dengan mudah dan cepat melalui platform terpadu yang mendorong
            kolaborasi antara mahasiswa, dosen, dan tendik untuk menciptakan lingkungan kampus yang lebih baik.
          </p>
          <button
            class="bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-white px-6 py-3 rounded text-lg transition-colors duration-300">Laporkan
            Kerusakan</button>

          <!-- <button class="bg-[var(--primary)] text-white px-6 py-3 rounded text-lg">Laporkan Kerusakan</button> -->
          <p class="mt-4 text-sm md:text-base">Ingin akses cepat? <a href="#"
              class="text-[var(--primary)] font-semibold">Minta Demo</a></p>
        </div>
    ...
    <section class="py-16" id="tentang">
      <div class="max-w-screen-xl mx-auto px-4 grid md:grid-cols-2 items-center gap-8">
        <div>
          <img src="{{ asset('assets/image/5.jpg') }}" alt="Tim Kami" class="rounded shadow-md w-full md:w-[90%]" />
        </div>
        <div>
          <h2 class="text-3xl md:text-4xl font-bold mb-4">Tentang Kami, <span
              class="text-[var(--primary)]">SIPASTI</span></h2>
          <p class="text-gray-700 leading-relaxed text-justify">
            <strong>Fokus pada perbaikan kampus, biarkan sistem kami yang menangani pelaporannya!</strong><br /><br />
            SIPASTI adalah platform pelaporan sarana dan prasarana kampus yang dikembangkan oleh tim profesional dari
            kalangan akademisi dan teknolog. Kami berkomitmen untuk menghadirkan solusi digital yang efisien,
            transparan, dan
            responsif dalam menanggapi kerusakan fasilitas demi menciptakan lingkungan belajar yang lebih nyaman dan
            produktif.
          </p>
      ...
      <div class="max-w-screen-xl mx-auto px-4 text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 text-left">
            ...
            <div class="mb-4 text-[var(--primary)]">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" fill="none" viewBox="0 0 24 24"
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M9 12h6m-6 4h6m2 4H7a2 2 0 01-2-2V6a2 2 0 012-2h3.28a2 2 0 011.43.6l.59.6h3.28a2 2 0 012 2v12a2 2 0 01-2 2z" />
              </svg>
            </div>
            <h3 class="font-bold text-[var(--primary)] mb-2">Mudah</h3>
            <p class="text-sm text-gray-600 text-base md:text-base">
              Aplikasi kami dirancang dengan antarmuka yang intuitif dan ramah pengguna, sehingga siapa pun, baik
              mahasiswa maupun staf, dapat melaporkan masalah tanpa perlu pelatihan teknis.
            </p>
          </div>
          ...
          <div class="bg-blue-100 p-6 rounded shadow">
            ...
            <p class="text-sm text-gray-600 text-base md:text-base">
              Setiap laporan yang masuk akan langsung diteruskan secara otomatis ke unit atau bagian yang bertanggung
              jawab, mempercepat proses penanganan tanpa harus melalui birokrasi berbelit.
            </p>
          </div>
          ...
          <div class="bg-blue-100 p-6 rounded shadow">
            ...
            <p class="text-sm text-gray-600 text-base md:text-base">
              Pengguna dapat memantau status laporan mereka secara langsung melalui sistem, mulai dari proses verifikasi
              hingga penyelesaian, sehingga memberikan kepercayaan dan akuntabilitas yang tinggi.
            </p>
          </div>
          ...
          <div class="bg-blue-100 p-6 rounded shadow">
            <div class="mb-4 text-[var(--primary)]">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M13 7H7v6h6V7zM5 3v2M5 19v2M19 3v2M19 19v2M3 5h2M3 19h2M21 5h-2M21 19h-2M17 7h4v10h-4zM3 7h4v10H3z" />
              </svg>
            </div>
            <h3 class="font-bold text-[var(--primary)] mb-2">Terintegrasi</h3>
            <p class="text-sm text-gray-600 text-base md:text-base">
              Sistem ini telah terhubung dengan berbagai layanan dan database kampus, memastikan setiap laporan dapat
              diproses secara efisien tanpa perlu input ulang atau proses manual.
            </p>
          </div>
        </div>
      </div>
    ...
    <footer class="bg-gray-100 py-8">
      <div class="max-w-screen-xl mx-auto px-4 text-center text-sm text-gray-500">©{{date('Y')}} SaranaKampus. All
        rights
        reserved.</div>
    </footer>
</body>
