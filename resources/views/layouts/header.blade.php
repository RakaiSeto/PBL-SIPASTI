<header class="flex justify-between items-center bg-white px-6 py-4 shadow relative">
    ...
    Ganti Profil
        ...
        <a href="#" onclick="openModal()" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Ganti Password</a>
...
<div id="modalProfile" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 onclick="closeModal(event)">
  <div class="bg-white w-full max-w-lg rounded-lg p-6 shadow-lg relative">
    <!-- Tombol Tutup -->
    <button onclick="closeModal()" class="absolute top-2 right-2 text-gray-500 hover:text-gray-700 text-lg">&times;</button>
  ...
  <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Foto Profil" class="w-24 h-24 rounded-full object-cover ring-2 ring-blue-500">
</div>
      <!-- Nama -->
      <div class="mb-4">
        <label class="block text-sm font-medium text-gray-700 mb-1">Nama</label>
        <input type="text" placeholder="Nama lengkap" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
      </div>

      <!-- Email -->
      <div class="mb-4">
        <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
        <input type="email" placeholder="email@example.com" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
      </div>
      ...
      <div class="mb-4">
        ...
        {{-- <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Preview" class="mt-2 w-20 h-20 rounded-full object-cover"> --}}
      </div>
