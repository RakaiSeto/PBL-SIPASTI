    ...
    <script>
            ...
            fetch(`/sarpras/laporan/${id}`, {
                ...
                .then(response => {
                    if (response.success) {
                        ...
                        img.src = data.lapor_foto_url ? data.lapor_foto_url : '/assets/profile/default.jpg';
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            return `
                            <div class="flex gap-2">
                                <button onclick="openDetail(${data.laporan_id})" title="Detail" class="flex items-center gap-1 px-3 py-1 text-white bg-blue-800 hover:bg-blue-700 rounded">
        ...
        function completeLaporan(laporanId) {
            fetch(`/sarpras/laporan/complete/${laporanId}`, {
                ...
                .catch(error => {
                    console.error('Penyelesaian gagal:', error);
                    showError('Gagal menyelesaikan laporan');
                });
        }
    </script>
@endsection
