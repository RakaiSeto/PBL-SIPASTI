<div id="detailModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 hidden transition-opacity duration-300">
    <div class="bg-white p-8 rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto transform transition-all duration-300 scale-95 flex flex-col justify-between">
        <div class="flex justify-between items-start mb-4">
            <h2 class="text-2xl font-bold text-gray-800">Detail Ruangan</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-4">
                <div>
                    <h4 class="font-medium text-gray-500">ID Ruangan</h4>
                    <p class="text-lg text-gray-800 ruangan_id">-</p>
                </div>
                <div>
                    <h4 class="font-medium text-gray-500">Jenis Ruangan</h4>
                    <p class="text-lg text-gray-800 ruangan_role_nama">-</p>
                </div>
                <div>
                    <h4 class="font-medium text-gray-500">Nama Ruangan</h4>
                    <p class="text-lg text-gray-800 ruangan_nama">-</p>
                </div>
                <div>
                    <h4 class="font-medium text-gray-500">Lantai</h4>
                    <p class="text-lg text-gray-800 lantai">-</p>
                </div>
            </div>
        </div>
