        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-lg p-6 relative">
            ...
            <div class="space-y-4 text-slate-900">
                <div class="form-group">
                    ...
                    <input id="addNama" name="fullname" type="text"
                        class="w-full border border-gray-300 px-3 py-2 rounded" placeholder="Masukkan nama lengkap"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input id="addUsername" name="username" type="text"
                        class="w-full border border-gray-300 px-3 py-2 rounded" placeholder="Masukkan username"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input id="addEmail" name="email" type="email"
                        class="w-full border border-gray-300 px-3 py-2 rounded" placeholder="Masukkan email" required>
                    <small id="error-email" class="error-text text-red-600"></small>
                </div>
                <div class="form-group">
                    <label for="addTelp" class="block mb-1 font-medium">Telp</label>
                    <input id="addTelp" name="no_telp" type="text"
                        class="w-full border border-gray-300 px-3 py-2 rounded" placeholder="Masukkan no telp" required>
                    <small id="error-no_telp" class="error-text text-red-600"></small>
                </div>
                <div class="form-group">
                    <label for="addRole" class="block mb-1 font-medium">Role</label>
                    <select id="addRole" name="role" class="w-full border border-gray-300 px-3 py-2 rounded"
                        required>
                        <option value="" disabled selected>Pilih Role</option>
                        @foreach ($RolePengguna as $role)
            ...
            <div class="flex justify-end gap-2 mt-6">
                ...
                <button type="submit"
                    class="px-4 py-2 bg-primary text-white rounded hover:bg-blue-700 text-sm">Simpan</button>
            </div>
            <button onclick="closeModal('addModal')"
                class="absolute top-2 right-2 text-gray-500 hover:text-red-500 text-lg">×</button>
        </div>
    </div>
</form>
