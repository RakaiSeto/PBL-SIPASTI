...
<div id="detailModal"
    ...
    <div
        class="bg-white p-8 rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto transform transition-all duration-300 scale-95 flex flex-col justify-between">
        <!-- Header -->
        <div class="flex justify-between items-start mb-4">
            <h2 class="text-2xl font-bold text-gray-800">Detail Laporan</h2>
            <button class="text-gray-500 hover:text-red-500 text-2xl font-bold transition duration-200"
        ...
        <div class="mt-6 text-right">
            <button onclick="closeModal('detailModal')"
                class="bg-primary hover:bg-primary text-white px-5 py-2 rounded-lg transition duration-200">Tutup</button>
        </div>
    </div>
