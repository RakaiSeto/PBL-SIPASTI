    ...
    <body>
        ...
        <h3 class="text-center" style="margin: 20px 0;">LAPORAN DATA ROLE RUANGAN</h3>

        <table>
            <thead>
                <tr>
                    <th class="text-center">No</th>
                    <th>Nama Role Ruangan</th>
                </tr>
            </thead>
            <tbody>
                @foreach($pengguna as $index => $ruanganRole)
                    <tr>
                        <td class="text-center">{{ $index + 1 }}</td>
                        <td>{{ $ruanganRole->ruangan_role_nama }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
