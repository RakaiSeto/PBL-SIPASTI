...
<body>
   ...
   <table class="summary-table">
    <tbody>
        ...
        <tr>
            <td style="text-align:left;">Total Fasilitas</td>
            <td style="text-align:right;">{{ $totalFasilitas }}</td>
        </tr>
        <tr>
    ...
    <table>
        ...
        <tbody>
            @foreach($kerusakanFasilitas as $kerusakan)
            <tr>
                <td>{{ $kerusakan->nama_fasilitas }}</td>
                <td class="text-right">{{ $kerusakan->jumlah }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $kr->ruangan_nama }}</td>
                <td>{{ $kr->fasilitas_nama }}</td>
